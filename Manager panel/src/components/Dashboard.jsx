...
import { buildStats, buildUsers, tabs } from './adminData';
...
export default function Dashboard() {
    ...
    const [loading, setLoading] = useState({ email: true, details: true });
    ...
    const isLoading = loading.email || loading.details;
